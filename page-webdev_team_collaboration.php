<?php
/*
Template Name: Web Dev Team Collaboration
*/
?>
<?php get_header(); ?>
      ...
      <div class="resource-row-wrapper">
        ...
        <div class="swiper mySwiper">
          <div class="category-heading-wrapper">
            <h3>Communicating to Designers</h3>
